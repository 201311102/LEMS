	...
	<div class="mypageContainer">
		...
		<div class="notice_wrap">
			...
			<div class="prdBox">
				...
				<div class="notice_content">
					<p>
						<textarea name="recontent" id="recontent"
							style="width: 100%; height: 500px;" placeholder="답변을 입력하세요.">${qna.recontent}</textarea>
				...
				<div align="center">
					<button class="button" onclick="updateReplyQ()" value="저장">저장</button>
