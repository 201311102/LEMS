			...
			<div class="prdBox">
				<div class="notice_head">
					...
					<p>
						...
						<span id="qtitleCount" style="color: green;">50</span><span>/50</span>
					</p>
				</div>
				<div class="notice_content">
					<p>
						<textarea name="qcontent" id="qcontent"
							style="width: 100%; height: 500px;" placeholder="내용을 입력하세요.">${qna.qcontent}</textarea>
				...
				<br />
				<div align="center">
					<button class="button" onclick="updateQ()" value="저장">저장</button>
