...
<script>
	function list(cate_id, page, order) {
	...
	<div id="pdc">
		<table id="product">
			<td><a href="#" id="order" value="ASC"
				onClick="list('${map.cate_id}', '1', 'ASC')">낮은가격</a> <a href="#"
				id="order" value="DESC"
				onClick="list('${map.cate_id}', '1', 'DESC')">높은가격</a></td>
			<td><input type="text" name="sPrd" id="sPrd"
				placeholder="검색어 입력"
				onkeypress="if(event.keyCode == 13) {searchPrd(); return;}">
				<br>
				<button type="button" id="searchBtn" onclick="innerSearch()"
